...
\bibitem{accs} Davydov A.V., Larionov A.A., Cherkashin E.A. On the calculus of positively constructed formulas for automated theorem proving // Automatic Control and Computer Sciences (AC\&CS). 2011. Volume 45, Issue 7, pp.~402--407. [Об исчислении позитивно-образованных формул для автоматического доказательства теорем]
...
\bibitem{mipro2} Larionov A., Terekhin I. Indexing Positively Constructed Formulas // MIPRO 2013. 36-th international convention on information and communication technology, electronics and microelectronics // MIPRO: Croatia, 2013. Vol.III, pp.~1281--1285. [Индексирование позитивно-образованных формул]
...
\bibitem{ACL2} ACL2 Version 5.0 [Электронный ресурс]. URL: http://www.cs.utexas.edu/users/moore/acl2/ (дата обращения: 18.12.2012).

\bibitem{DPL1} D Programming Language [Электронный ресурс]. URL: http://www.digitalmars.com/d/ (дата обращения: 18.12.2012).

\bibitem{eprover} E Prover [Электронный ресурс]. URL: http://www.eprover.org (дата обращения: 18.12.2012).

\bibitem{EQP} EQP [Электронный ресурс]. URL: http://www.cs.unm.edu/\~mccune/eqp/ (дата обращения: 18.12.2012).

\bibitem{gmemory} GLIB: Memory Slices [Электронный ресурс]. URL: http://developer.gnome.org/glib/2.34/glib-Memory-Slices.html (дата обращения: 18.12.2012).

\bibitem{iprover} iProver [Электронный ресурс]. URL: http://www.cs.man.ac.uk/~korovink/\\/iprover/ (дата обращения: 18.12.2012).

\bibitem{Isabelle} Isabelle [Электронный ресурс]. URL: http://isabelle.in.tum.de/ (дата обращения: 18.12.2012).

\bibitem{keyproj} The KeY Project [Электронный ресурс]. URL: http://www.key-project.org/ (дата обращения: 18.12.2012).

\bibitem{leancop} LeanCoP [Электронный ресурс]. URL: http://www.leancop.de (дата обращения: 18.12.2012).

\bibitem{leoprover} Loprover [Электронный ресурс]. URL: http://www.ags.uni-sb.de/\~leo/ (дата обращения: 18.12.2012).

\bibitem{ModalProver} MOLTAP — A Modal Logic Tableau Prover [Электронный ресурс]. URL: http://twan.home.fmf.nl/moltap/ (дата обращения: 18.12.2012).

\bibitem{ontobox} Ontobox [Электронный ресурс]. URL: http://ontobox.org/ (дата обращения: 18.12.2012).

\bibitem{otter} Otter [Электронный ресурс]. URL: http://www.cs.unm.edu/~mccune/ot\-ter/ (дата обращения: 18.12.2012).

\bibitem{CASC} The CADE ATP System Competition. The World Championship for Automated Theorem Proving [Электронный ресурс]. URL: http://www.cs.miami.edu/~tptp/CASC/ (дата обращения: 18.12.2012).

\bibitem{LaCoq} The Coq Proof Assistant [Электронный ресурс]. URL: http://coq.inria.fr/ (дата обращения: 18.12.2012).

\bibitem{HOLprover} The HOL Theorem Prover for Higher Order Logic [Электронный ресурс]. URL: http://www.cs.ox.ac.uk/tom.melham/res/hol.html (дата обращения: 18.12.2012).

\bibitem{tptp} Thousands of Problems for Theorem Provers [Электронный ресурс]. URL: http://tptp.org/ (дата обращения: 18.12.2012).

\bibitem{TPTPTrans} A.V.Gelder. TPTPparser utility. 2006 [Электронный ресурс]. URL: http://users.soe.ucsc.edu/\~{}avg/TPTPparser/ (дата обращения: 18.12.2012).

\bibitem{vprover} Vampire [Электронный ресурс]. URL: http://www.vprover.org (дата обращения: 18.12.2012).
