...
\bibitem{ACL2} ACL2 Version 5.0. [Электронный ресурс]. -- URL: http://www.cs.utexas.edu/users/moore/acl2/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{DPL1} D Programming Language. [Электронный ресурс]. -- URL: http://www.digitalmars.com/d/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{eprover} E Prover. [Электронный ресурс]. -- URL: http://www.eprover.org -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{EQP} EQP. [Электронный ресурс]. -- URL: http://www.cs.unm.edu/\~mccune/eqp/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{gmemory} GLIB: Memory Slices. [Электронный ресурс]. -- URL: http://developer.gnome.org/glib/2.34/glib-Memory-Slices.html -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{iprover} iProver. [Электронный ресурс]. -- URL: http://www.cs.man.ac.uk/~korovink/iprover/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{Isabelle} Isabelle. [Электронный ресурс]. -- URL: http://isabelle.in.tum.de/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{keyproj} The KeY Project. [Электронный ресурс]. -- URL: http://www.key-project.org/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{leancop} LeanCoP. [Электронный ресурс]. -- URL: http://www.leancop.de -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{leoprover} Loprover. [Электронный ресурс]. -- URL: http://www.ags.uni-sb.de/\~leo/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{ModalProver} MOLTAP — A Modal Logic Tableau Prover. [Электронный ресурс]. -- URL: http://twan.home.fmf.nl/moltap/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{ontobox} Ontobox. [Электронный ресурс]. -- URL: http://ontobox.org/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{otter} Otter. [Электронный ресурс]. -- URL: http://www.cs.unm.edu/~mccune/ot\-ter/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{CASC} The CADE ATP System Competition. The World Championship for Automated Theorem Proving. [Электронный ресурс]. -- URL: http://www.cs.miami.edu/~tptp/CASC/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{LaCoq} The Coq Proof Assistant. URL: http://coq.inria.fr/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{HOLprover} The HOL Theorem Prover for Higher Order Logic. [Электронный ресурс]. -- URL: http://www.cs.ox.ac.uk/tom.melham/res/hol.html -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{tptp} Thousands of Problems for Theorem Provers. [Электронный ресурс]. -- URL: http://tptp.org/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{TPTPTrans} A.V.Gelder. TPTPparser utility. 2006. [Электронный ресурс]. -- URL: http://users.soe.ucsc.edu/\~{}avg/TPTPparser/ -- Загл. с экрана (дата обращения: 8.12.2012).

\bibitem{vprover} Vampire. [Электронный ресурс]. -- URL: http://www.vprover.org -- Загл. с экрана (дата обращения: 8.12.2012).
