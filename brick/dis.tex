...
\usepackage[unicode=true,colorlinks=true,pdfstartview=FitH,pdfpagemode=UseOutlines,linkcolor=black,citecolor=black,urlcolor=black,pdftitle={dis},pdfauthor={snigavik},pdfkeywords={},pdfproducer={LaTeX},pdfcreator={LaTeX}]{hyperref}
...
%\setlength{\footskip}{13mm} % Расстояние от нижней грани текста до нижней грани номера страницы
